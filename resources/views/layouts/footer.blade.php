...
<footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-6 footer-newsletter" style="margin-right: 50px;">
          <a href="{{ route('home') }}"><img src="{{ asset('assets/img/logo/logo.png') }}" alt="" class="img-fluid" style="width: 150px;"></a>
          <br><br>
  ...
  <div class="footer p-5 pt-4 pb-3 d-md-flex text-light" style="background-color: #E8853D;">
    <div class="me-md-auto text-center text-md-start">
      <div class="copyright">
        &copy; {{ now()->year }} Copyright <strong><span>WM Hana Asri</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        By Tim C5 - MIF'21
      </div>
